...
function initDialog() {
    var panelWidth = 800;
    var initDialog = new Window("dialog", "Automasi Input dari Excel ke Indesign", undefined, {resizeable: false});
    var message = initDialog.add("panel", undefined, "Brief Explanation");
    var firstPanel = initDialog.add("panel", undefined, "Versi");
    var secPanel = firstPanel.add("group");
    var confirmationButton = initDialog.add("group");
    initDialog.orientation = "column";
    initDialog.alignChildren = ["center", "top"];
    initDialog.spacing = 8;
    initDialog.margins = 15;
    message.orientation = "column";
    message.alignChildren = ["left", "top"];
    message.margins = 10;
    message.spacing = 4;
    message.preferredSize.width = panelWidth;
    message.add("statictext", undefined, "Script ini dibuat untuk meningkatkan kolaborasi antar satker dalam menyusun publikasi");
    firstPanel.orientation = "column";
    firstPanel.alignChildren = ["left", "top"];
    firstPanel.margins = 10;
    firstPanel.preferredSize.width = panelWidth;
    secPanel.orientation = "column";
    secPanel.alignChildren = ["left", "top"];

    secPanel.add("statictext", undefined, "Developer : BPS Kabupaten Lampung Utara");
    secPanel.add("statictext", undefined, "Latest Version cek di github.com/gerynastiar");
    confirmationButton.orientation = "row";
    confirmationButton.alignChildren = ["center", "center"];
    confirmationButton.spacing = 10;

    var start = confirmationButton.add("button", undefined, "Asiap Yay!");
